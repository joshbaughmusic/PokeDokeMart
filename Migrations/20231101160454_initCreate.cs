    ...
    public partial class initCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "dbc40bc6-0829-4ac5-a3ed-180f5e916a5f", 0, "4aae0ad6-1088-49e7-8eef-ecaa7bd3980f", "ash@pokenet.com", false, false, null, null, null, "AQAAAAIAAYagAAAAEAtbOK444hQwMkTeFna9jnqYVFGtSJKwP51hssA80sslSCLhFxf5jXNpO0F68BLcTw==", null, false, "887a5f4a-453c-4dc2-a6f9-b08640d4280b", false, "Administrator" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 103, 11, 40000m, "The foe is slugged by a punch thrown with muscle-packed power.", "Teaches Mega Punch to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 1, "TM01", "Inflicts regular damage with no additional effect." },
                    { 104, 11, 1000m, "Inflicts regular damage.  User's critical hit rate is one level higher when using this move.  User charges for one turn before attacking. This move cannot be selected by sleep talk.", "Teaches Razor Wind to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 2, "TM02", "Requires a turn to charge before attacking." },
                    { 105, 11, 50000m, "Raises the user's Attack by 2 stages.", "Teaches Swords Dance to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 3, "TM03", "Raises the user's Attack by 2 stages." },
                    { 106, 11, 50000m, "Switches the target out for another of its trainer's Pokémon selected at random.  Wild battles end immediately. Doesn't affect Pokémon with suction cups or under the effect of ingrain.", "Teaches Whirl Wind to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 4, "TM04", "Immediately ends wild battles. Forces trainers to switch Pokémon." },
                    { 107, 11, 50000m, "The foe is attacked by a kick launched with muscle-packed power.", "Teaches Mega Kick to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 5, "TM05", "Inflicts regular damage with no additional effect." },
                    { 108, 11, 1000m, "The target is badly poisoned, with the damage caused by poison doubling after each turn.", "Teaches Toxic to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 6, "TM06", "Badly poisons the target, inflicting more damage every turn." },
                    { 109, 11, 1000m, "The target faints; doesn't work on faster or higher-leveled Pokemon.", "Teaches Horn Drill to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 7, "TM07", "Inflicts damage equal to the target's max HP. Ignores accuracy and evasion modifiers." },
                    { 110, 11, 1000m, "The user attacks by dropping onto the target with its full body weight. This may also leave the target with paralysis.", "Teaches Body Slam to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 8, "TM08", "Inflicts regular damage with no additional effect. Has a chance to paralyze the target." },
                    { 111, 11, 10000m, "A reckless, full-body charge attack for slamming into the foe. It also damages the user a little.", "Teaches Take Down to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 9, "TM09", "Inflicts regular damage. User takes 1/4 the damage it inflicts in recoil." },
                    { 112, 11, 1000m, "A life-risking tackle that also hurts the user.", "Teaches Double Edge to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 10, "TM10", "Inflicts regular damage. User takes 1/3 the damage it inflicts in recoil." },
                    { 113, 11, 10000m, "Forcefully sprays bubbles that may lower speed.", "Teaches Bubble Beam to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 11, "TM11", "Inflicts regular damage. Has a chance to lower the target's speed by one stage." },
                    { 114, 11, 50000m, "The foe is struck with a lot of water expelled forcibly from the mouth.", "Teaches Water Gun to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 12, "TM12", "Inflicts regular damage with no additional effect." },
                    { 115, 11, 10000m, "Blasts the foe with an icy beam that may freeze it.", "Teaches Ice Beam to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 13, "TM13", "Inflicts regular damage.  Has a chance to freeze the target." },
                    { 116, 11, 1000m, "A howling blizzard is summoned to strike the foe. It may also freeze the target solid.", "Teaches Blizzard to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 14, "TM14", "Inflicts regular damage.  Has a chance to freeze the target." },
                    { 117, 11, 1000m, "A severely damaging attack that makes the user rest on the next turn.", "Teaches Hyper Beam to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 15, "TM15", "Inflicts regular damage. User loses its next turn to recharge, and cannot attack or switch out during that turn." },
                    { 118, 11, 1000m, "Numerous coins are hurled at the foe to inflict damage. Money is earned after battle.", "Teaches Pay Day to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 16, "TM16", "Inflicts regular damage.  After the battle ends, the winner receives five times the user's level in extra money for each time this move was used." },
                    { 119, 11, 10000m, "The user grabs the foe and recklessly dives for the ground. It also hurts the user slightly.", "Teaches Submission to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 17, "TM17", "Inflicts regular damage. User takes 1/4 the damage it inflicts in recoil." },
                    { 120, 11, 10000m, "A retaliation move that counters any physical attack, inflicting double the damage taken.", "Teaches Counter to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 18, "TM18", "Targets the last opposing Pokémon to hit the user with a physical move this turn.  Inflicts twice the damage that move did to the user." },
                    { 121, 11, 10000m, "The foe is thrown using the power of gravity. It inflicts damage equal to the user's level.", "Teaches Seismic Toss to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 19, "TM19", "Inflicts damage equal to the user's level. Type immunity applies, but other type effects are ignored." },
                    { 122, 11, 100000m, "While this move is in use, it gains attack power each time the user is hit in battle.", "Teaches Rage to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 20, "TM20", "Inflicts regular damage. Every time the user is hit after it uses this move but before its next action, its Attack raises by one stage." },
                    { 123, 11, 1000m, "A nutrient-draining attack. The user's HP is restored by half the damage taken by the target.", "Teaches Mega Darin to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 21, "TM21", "Inflicts regular damage. Drains half the damage inflicted to heal the user." },
                    { 124, 11, 1000m, "A two-turn attack. The user gathers light, then blasts a bundled beam on the second turn.", "Teaches SolarBeam to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 22, "TM22", "Inflicts regular damage. User charges for one turn before attacking." },
                    { 125, 11, 10000m, "The user attacks with a dragon-like force that always inflicts 40 points of damage.", "Teaches Dragon Rage to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 23, "TM23", "Always deals 40 points of damage." },
                    { 126, 11, 1000m, "A strong electric blast is loosed at the foe. It may also leave the foe paralyzed.", "Teaches Thunderbolt to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 24, "TM24", "Inflicts regular damage. Has a chance to paralyze the target." },
                    { 127, 11, 10000m, "A wicked thunderbolt is dropped on the foe to inflict damage. It may also leave the target paralyzed.", "Teaches Thunder to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 25, "TM25", "Inflicts regular damage. Has a chance to paralyze the target." },
                    { 128, 11, 1000m, "The user sets off an earthquake that hits all the Pokémon in the battle.", "Teaches Earthquake to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 26, "TM26", "Inflicts regular damage. If the target is in the first turn of dig, this move will hit with double power." },
                    { 129, 11, 1000m, "The user opens up a fissure in the ground and drops the foe in. The target instantly faints if it hits.", "Teaches Fissure to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 27, "TM27", "Inflicts damage equal to the target's max HP. Ignores accuracy and evasion modifiers." },
                    { 130, 11, 100000m, "The user burrows, then attacks on the second turn. It can also be used to exit dungeons.", "Teaches Dig to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 28, "TM28", "Swift can hit the user while underground, and no other moves can." },
                    { 131, 11, 1000m, "The foe is hit by a strong telekinetic force. It may also reduce the foe's Sp. Def stat.", "Teaches Psychic to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 29, "TM29", "Inflicts regular damage. Has a chance to lower the target's Special Defense by one stage." },
                    { 132, 11, 1000m, "Use it to flee from any wild Pokémon. It may also be used to warp to the last Poké Center visited.", "Teaches Teleport to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 30, "TM30", "Does nothing. Wild battles end immediately." },
                    { 133, 11, 1000m, "The user copies the move last used by the foe. The move can be used for the rest of the battle.", "Teaches Mimic to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 31, "TM31", "This move is replaced by the target's last successfully used move, and its PP changes to 5." },
                    { 134, 11, 10000m, "By moving rapidly, the user makes illusory copies of itself to raise its evasiveness.", "Teaches Double Team to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 32, "TM32", "Raises the user's evasion by one stage." },
                    { 135, 11, 10000m, "A wondrous wall of light is put up to suppress damage from physical attacks for five turns.", "Teaches Reflect to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 33, "TM33", "Erects a barrier around the user's side of the field that reduces damage from physical attacks by half for five turns" },
                    { 136, 11, 10000m, "User waits for two turns.  On the second turn, the user inflicts twice the damage it accumulated on the last Pokémon to hit it.", "Teaches Bide to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 34, "TM34", "The user endures attacks for two turns, then strikes back double." },
                    { 137, 11, 10000m, "The user performs a random move; almost any known move can be selected.", "Teaches Metronome to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 35, "TM35", "The user performs a random move; almost any known move can be selected." },
                    { 138, 11, 10000m, "The user blows up to inflict damage on all Pokémon in battle. The user faints upon using this move.", "Teaches Self-Destruct to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 36, "TM36", "User faints, even if the attack fails or misses.  Inflicts regular damage." },
                    { 139, 11, 10000m, "A large egg is hurled with maximum force at the foe to inflict damage.", "Teaches Eggbomb to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 37, "TM37", "Inflicts regular damage with no additional effect." },
                    { 140, 11, 10000m, "The foe is attacked with an intense blast of all-consuming fire. It may also leave the target with a burn.", "Teaches Fire Blast to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 38, "TM38", "Inflicts regular damage. Has a chance to burn the target." },
                    { 141, 11, 1000m, "Star-shaped rays are shot at the foe. This attack never misses.", "Teaches Swift to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 39, "TM39", "Inflicts regular damage. Ignores accuracy and evasion modifiers." },
                    { 142, 11, 1000m, "The user tucks in its head to raise its Defense in the first turn, then rams the foe on the next turn.", "Teaches Skull Bash to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 40, "TM40", "Inflicts regular damage. Raises the user's Defense by one stage.  User then charges for one turn before attacking." },
                    { 143, 11, 1000m, "Restores 1/2 of the user's max HP. However, this move fails if the user's current HP is 511 or 255 HP below its value at full health.", "Teaches Soft-Boiled to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 41, "TM41", "Restores 1/2 of the user's max HP. However, this move fails if the user's current HP is 511 or 255 HP below its value at full health." },
                    { 144, 11, 1000m, "An attack that works only on a sleeping foe. It absorbs half the damage caused to heal the user's HP.", "Teaches Dream Eater to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 42, "TM42", "Restores the user's HP by 1/2 of the damage inflicted on the target but only works on a sleeping target." },
                    { 145, 11, 1000m, "A second-turn attack move with a high critical-hit ratio. It may also make the target flinch.", "Teaches Sky Attack to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 43, "TM43", "Inflicts regular damage. User charges for one turn before attacking." },
                    { 146, 11, 1000m, "User falls to sleep and immediately regains all its HP.  If the user has another major status effect, sleep will replace it.", "Teaches Rest to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 44, "TM44", "User falls to sleep and immediately regains all its HP.  If the user has another major status effect, sleep will replace it." },
                    { 147, 11, 1000m, "A weak electric charge is launched at the target. It causes paralysis if it hits.", "Teaches Thunder Wave to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 45, "TM45", "A weak jolt of electricity that paralyzes the foe." },
                    { 148, 11, 1000m, "The foe is attacked with an odd, hot energy wave. The attack varies in intensity.", "Teaches Psywave to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 46, "TM46", "Inflicts typeless damage between 50% and 150% of the user's level, selected at random in increments of 10%." },
                    { 149, 11, 1000m, "The user explodes to inflict terrible damage even while fainting itself.", "Teaches Explosion to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 47, "TM47", "Halves the target's Defense for damage calculation, which is similar to doubling the attack's power." },
                    { 150, 11, 10000m, "The user slams a barrage of rocks down on the target from above.", "Teaches Rock Slide to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 48, "TM48", "Inflicts regular damage.  Has a chance to make the target flinch." },
                    { 151, 11, 10000m, "The user strikes with a simultaneous three- beam attack. May also paralyze, burn, or freeze the target.", "Teaches Echoed Voice to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 49, "TM49", "Inflicts regular damage. Has a chance to burn, freeze, or paralyze the target." },
                    { 152, 11, 1000m, "The user takes one-fourth of its maximum HP to create a substitute; this move fails if the user does not have enough HP for this.", "Teaches Substitute to a compatible Pokémon.", "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/tm-normal.png", 50, "TM50", "The user takes one-fourth of its maximum HP to create a substitute." }
                });
