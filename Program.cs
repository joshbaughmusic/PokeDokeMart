...
builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
    ...
    {
        options.Cookie.Name = "PokeDokeMartReduxLoginCookie";
...
builder.Services.AddIdentityCore<IdentityUser>(config =>
    ...
    .AddEntityFrameworkStores<PokeDokeMartReduxDbContext>();
...
builder.Services.AddNpgsql<PokeDokeMartReduxDbContext>(builder.Configuration["PokeDokeMartReduxDbConnectionString"]);
